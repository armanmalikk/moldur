          ...
          // jq(document).ready(function(){
           ...
           var size=[10,15.1];
            ...
            jq("#landscape-view-btn").click(function(){
              ...
              jq(".frame-box-landscape").show();
                if(margin==0){
                jq(".landscapeImg").removeClass("cm3Border").removeClass("cm5Border").addClass("noborder");
              }else if(margin==3){
                jq(".landscapeImg").removeClass("noborder").removeClass("cm5Border").addClass("cm3Border");
              }else if(margin==5){
                jq(".landscapeImg").removeClass("noborder").removeClass("cm3Border").addClass("cm5Border");
              }
            })
            ...
            ************************************/
            ...
            function  generateOutput(size,border,protection){
               ...
               w = size[1]; 
               armnanum1 = Number(h);
              var select_fram_prize= document.getElementById("active-fram-prize").value;
                var n = Number(select_fram_prize)
                console.log(n);
                
              jq("#printing-size").html(h+"x"+w);

              jq("#final-size").html((h+border)+"x"+(w+border));
              var squre = (h+h+w+w)/100;
              total_price = squre*10+n;
              jq("#final-price").html(total_price.toFixed(2));
                
                jq('#active-fram-total-prize').val(total_price);
                jq('#active-fram-total-size').val(h+"x"+w);
            }
            /***********************************
                     click fram id
            ************************************/
              jq(".frames").click(function(res){
            ...
            ************************************/
            ...
            jq(".height-width-submit").click(function(res){
                 
                var d = document.getElementsByClassName("get-height")[0].value;
                var e = document.getElementsByClassName("get-width")[0].value;
                 h = Number(d)
                 w = Number(e)
                var input_add = h+w;
            ...
            ************************************/
            ...
            jq(".get-protection").click(function(res){
              ...
              var squre = (h+h+w+w)/100;
             var glass = (h*w)/10000
               total_price = squre*10+(90*glass)+n; 
                jq("#final-price").html(total_price.toFixed(2));
            });
            
             function Addprocedure(){
    if($('.height-width-submit').data('clicked')){
        console.log("hello");
    } else {
        console.log("bye");
    }
