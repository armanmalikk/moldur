...
<!-- <div class="frame-box-landscape">
  ...
  <div class="image-box-landscape">
    <img src=<?php echo $chosen_image; ?> class="landscapeImg noborder main-img" alt=""/>
								   ...
								   <div class="col-sm-4">
                                     <input type="file" name="customer_uploaded_image_wall" data-backId="well_image1" class="file-wall" />
                    </div>
							   </div>
						 </div>
						 <div id="pan">
						     <div class="col-sm-12" id="well_image2">
								   ...
								   <div class="col-sm-4">
                                       <input type="file" name="customer_uploaded_image_wall" data-backId="well_image2" class="file-wall" />
                                   </div>
							   </div>
						 </div>
						 <div id="note">
						    <div class="col-sm-12" id="well_image3">
								   ...
								   <div class="col-sm-4">
                                       <form>
                                        <input type="file" name="customer_uploaded_image_wall" data-backId="well_image3" class="file-wall" />
                                       </form>
						 ...
						 <div id="car">
						   <div class="col-sm-12" id="well_image4">
							   ...
							   <div class="col-sm-4">
                                   <form>
                                    <input type="file" name="customer_uploaded_image_wall" data-backId="well_image4" class="file-wall" />
                                   </form>
						 ...
						 <div id="well">
						   <div class="col-sm-12" id="well_image5">
							   ...
							   <div class="col-sm-4">
                                   <form>
                                    <input type="file" name="customer_uploaded_image_wall" data-backId="well_image5" class="file-wall" />
                                   </form>
                               </div>
						   </div>
						 </div>
